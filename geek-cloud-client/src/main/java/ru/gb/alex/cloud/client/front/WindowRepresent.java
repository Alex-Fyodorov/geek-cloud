...
public class WindowRepresent extends JFrame implements Represent {
    ...
    public WindowRepresent(RequestSender requestSender) {
        this.requestSender = requestSender;

        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        addWindowListener(new WindowListenerImpl(requestSender));
    ...
    public void login(String username, String password, CommandForServer command) {
        requestSender.sendAuth(username, password, command);
        try {
            confirmLogin.await();
